    ...
    def _retrieve_tables(self, dataset):
        ...
        for page in self._page_table_list_results(dataset):
            ...
            for table in page['tables']:
                ...
                table_last_upd = TableLastUpdated(table_name=table_id, last_updated_time_epoch="1597833028836",schema=tableRef['datasetId'],db='bigquery',cluster=tableRef['projectId'])
