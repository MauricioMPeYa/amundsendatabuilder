...
def run_hive_last_updated_job(job_name):
    ...
    partitioned_table_where_clause = " "
    non_partitioned_table_where_clause = " "
    ...
    job_config = ConfigFactory.from_dict({
	    ...
	    'extractor.hive_table_last_updated.extractor.sqlalchemy.{}'.format(SQLAlchemyExtractor.CONN_STRING): connection_string(),
	    'extractor.hive_table_last_updated.extractor.fs_worker_pool_size': pool_size,
        'extractor.hive_table_last_updated.filesystem.{}'.format(FileSystem.DASK_FILE_SYSTEM): hdfs3.HDFileSystem(),
        'loader.filesystem_csv_neo4j.node_dir_path': node_files_folder,
        'loader.filesystem_csv_neo4j.relationship_dir_path': relationship_files_folder,
        'loader.filesystem_csv_neo4j.delete_created_directories': True,
        'publisher.neo4j.node_files_directory': node_files_folder,
...
if __name__ == "__main__":
    ...
    if create_connection(DB_FILE):
        ...
        run_hive_last_updated_job("test_hive_last_updated_mauricio")
